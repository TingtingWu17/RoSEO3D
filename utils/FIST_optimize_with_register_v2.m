function [gammanew_out,loc_re_new_out,NLL_output] = FIST_optimize_with_register_v2(loc_re_init,SMLM_img_re,b,imgPara)
...
gammaold = [gammaold;zeros(6,size(gammaold,2))];

[G_re,~,~] = update_basisMatrix_w_register(N,gammaold,loc_re_old,imgPara);

[gammanew_out,loc_re_new_out,NLL_cur_out] = FISTA_w_register(SMLM_img_re,b,gammaold,loc_re_old,r,r_R,G_re,MaxIt,Lmax,imgPara);      
