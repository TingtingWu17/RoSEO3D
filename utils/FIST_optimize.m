function [gammanew_out,loc_re_new_out,NLL_output,G_re_out] = FIST_optimize(gamma_init,loc_re_init,SMLM_img_re,b,MaxIt,Lmax,imgPare)
r = 58.5/100/2*2;
...
gammaold = f_projection2(gammaold,r);
count = 0;
...
%      end
     ...
     z_update = f_projection2(z-1/l_it.*gradient_cur,r);
     ...
     l_it = (eta.^ik)* l_it;
     gammanew = f_projection2(z-1/l_it.*gradient_cur,r);
